...
public class MainController implements Initializable {
    ...
    private void loadAddBook(ActionEvent event) {
        loadWindow("/libraryassistant/ui/addbook/addBook.fxml","Add New Book");
    ...
    private void loadbookinfo(ActionEvent event) {
        clearBookCache();
            ...
            while(rs.next()){
                ...
                String status = (bStatus)?"Availablie" : "Not Availaible";
    ...
    private void loadIssueOperation(ActionEvent event) {
        ...
        alert.setTitle("Confim Issue Operation");
    ...
    private void loadSubmissionOperation(ActionEvent event) {
        ...
        if(databaseHandler.execAction(ac1)&&databaseHandler.execAction(ac2)){
            ...
            alert1.setHeaderText(null);
            alert1.setContentText("Thanks!!Book Has Been Returned");
            alert1.showAndWait();
